...
const freeTimeTask = document.getElementById('freeTime');
const datingTask = document.getElementById('dating');
...
function selectTask (e){
    ...
    switch(e.target.id){
        ...
        case 'study':
            ...
            break
        case 'freeTime':
            activeTask(freeTimeTask, taskColor);
            icon = '<i class="fas fa-tv"></i>'
            break
        case 'dating':
            activeTask(datingTask, taskColor);
